...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'KPIValue.kpi'
        db.alter_column('graphs_kpivalue', 'kpi_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['graphs.KPI']))

    def backwards(self, orm):

        # Changing field 'KPIValue.kpi'
        db.alter_column('graphs_kpivalue', 'kpi_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['graphs.KPIValue']))
