...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('graphs_dashboard', (
        ...
        db.send_create_signal('graphs', ['Dashboard'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('graphs_dashboard')
    ...
    models = {
        ...
        'graphs.kpigenerator': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'max_value': ('django.db.models.fields.PositiveIntegerField', [], {'default': '100'}),
